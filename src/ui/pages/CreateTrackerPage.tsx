...
import { createTracker, addField } from '@/core/db';
...
async function handleCreate() {
  ...
  return (
    <div className="min-h-full max-w-2xl mx-auto px-6 py-10">
      ...
      <label className="block text-grape-700 text-[13px] font-semibold mb-2">Name</label>
      <input
        type="text"
        autoFocus
        value={name}
      ...
      <div className="flex items-center justify-between mb-3">
        <label className="text-grape-700 text-[13px] font-semibold">Fields</label>
